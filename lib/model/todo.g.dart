...
extension TodoQueryWhereSort on QueryBuilder<Todo, Todo, QWhere> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhere> anyStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TodoQueryWhere on QueryBuilder<Todo, Todo, QWhereClause> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> statusEqualTo(Status status) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'status',
        value: [status],
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> statusNotEqualTo(Status status) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> statusGreaterThan(
    Status status, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> statusLessThan(
    Status status, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> statusBetween(
    Status lowerStatus,
    Status upperStatus, {
    bool includeLower = true,
    bool includeUpper = true,
